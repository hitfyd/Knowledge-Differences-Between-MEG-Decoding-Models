...
def eegnex(channels=204, points=100, num_classes=2, **kwargs):
    ...
    if points == 100:   # CamCAN Dataset
        ...
        sfreq = 125
    chs_info = None
    filter_1, filter_2 = 4, 30
    return EEGNeX(n_outputs=num_classes, n_chans=channels, n_times=points, filter_1=filter_1, filter_2=filter_2,
