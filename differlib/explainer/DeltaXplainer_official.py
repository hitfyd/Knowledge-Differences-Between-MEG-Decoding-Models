...
from .deltaxplainer.decision_tree import get_rules_decision_tree
...
class DeltaExplainer_Official(DISExplainer):
    """
    ...
    def __init__(self):
        ...
        super(DeltaExplainer_Official, self).__init__()
    ...
    def fit(self, X_train: pd.DataFrame, Y1, Y2, max_depth, min_samples_leaf=1, ccp_alpha=0.0, verbose=True, **kwargs):
        ...
        self.delta_tree, _ = get_rules_decision_tree(X_train, delta_target, params=params)
